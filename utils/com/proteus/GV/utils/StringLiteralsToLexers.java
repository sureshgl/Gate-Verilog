...
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Lexer;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.AlternativeContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.ElementContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.LabeledAltContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.LexerAltContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.LexerElementContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4Parser.RuleSpecContext;
import com.proteus.GV.ANTLRv4.gen.ANTLRv4ParserBaseVisitor;
...
public class StringLiteralsToLexers extends ANTLRv4ParserBaseVisitor<String> {
	...
	private StringBuilder ptemp;
	private StringBuilder ltemp;
	private StringBuilder temp;

	public StringLiteralsToLexers() {
		literals = new ArrayList<String>();
		ptemp = new StringBuilder();
	 ...
	 * lexerBlock ebnfSuffix? | ACTION QUESTION? // actions only allowed at end
	 * of outer alt actually, // but preds can be anywhere ;
	 * 
	 */
	...
	public String visitLexerCommands(@NotNull ANTLRv4Parser.LexerCommandsContext ctx) {
		temp.append(" ->");
		String prefix = "";
		for (ANTLRv4Parser.LexerCommandContext l : ctx.lexerCommand()) {
			temp.append(prefix);
			prefix = ",";
	...
	List<RuleSpecContext> getRuleSpecList() throws IOException {
		File verilogFile = new File("./grammar/GV.g4");
	...
	public static void main(String args[]) throws IOException {
		File file = new File("./grammar/GV_ext.g4");
		if ( ! file.exists( ) )
	    {
	        file.createNewFile( );
	    }
	    ...
	    bw.write("grammar GV_ext;\n");
	    bw.write("@header{ import com.proteus.GV.ext.*; }\n" );
		...
		System.out.println(stringLiteralsToLexers.ptemp);
		System.out.println(stringLiteralsToLexers.ltemp);
		bw.write(stringLiteralsToLexers.ptemp.toString());
		bw.write(stringLiteralsToLexers.ltemp.toString().trim());
		bw.flush();
		bw.close();
	}
}
