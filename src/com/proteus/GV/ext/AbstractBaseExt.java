...
import com.proteus.GV.ExtendedContextVisitor;
import com.proteus.GV.GetFormattedText;
import com.proteus.GV.PopulateExtendedContextVisitor;
import com.proteus.GV.SetExtendedContextVisitor;
...
public abstract class AbstractBaseExt implements GetFormattedText{
	...
	protected GV_extParser getPrimeParser(String str){
		GV_extLexer lexer = new GV_extLexer(new ANTLRInputStream(str));
		CommonTokenStream tokens = new CommonTokenStream(lexer);
		return new GV_extParser(tokens);
	}
